...
def robot_config(robot_name: str, **updates) -> RobotConfig:
    ...
    Args:
        robot_name: Name of the robot type (smpl, smplx, amp, g1, g1_wheel, h1_2, soma23)
    ...
    elif robot_name == "g1_wheel":
        from protomotions.robot_configs.g1_wheel import G1WheelRobotConfig

        config = G1WheelRobotConfig()
